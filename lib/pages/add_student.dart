...
class AddStudentPage extends StatelessWidget {
            ...
            children: [
              ...
              Form(
                ...
                child: Column(
                  children: [
                    Obx(() {
                      return userImageController.imageFile == null
                          ? ElevatedButton(
                              onPressed: () {
                                _pickImage(userImageController);
                              },
                    ...
                    TextFormField(
                      controller: addStudentController.batchController,
                    ...
                    const SizedBox(height: 20.0),
                    TextFormField(
                      controller: addStudentController.contactController,
                    ...
                    TextFormField(
                      controller: addStudentController.addressController,
                      keyboardType: TextInputType.text,
                      decoration: const InputDecoration(
                        labelText: 'Address',
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                            ...
                            onPressed: () async {
                              if (addStudentController.formKey.currentState!
                                  .validate()) {
                                var student = User();
                                student.name =
                                    addStudentController.nameController.text;
                                student.address =
                                    addStudentController.addressController.text;
                                student.batch =
                                    addStudentController.batchController.text;
                                student.contact =
                                    addStudentController.contactController.text;
                                student.imagePath =
                                    userImageController.imageFile?.path ?? '';
                                var result =
                        ...
                        ElevatedButton(
                            style: const ButtonStyle(
                                ...
                                minimumSize:
                                    WidgetStatePropertyAll(Size(100, 50))),
                            onPressed: () {
                              userImageController.setImageFile(null);
                              addStudentController.clearText();
                              addStudentController.formKey.currentState!
                                  .reset();
                            },
                            child: const Text(
                              'Clear',
  ...
  Future<void> _pickImage(UserImageGetx userController) async {
    final pickedFile =
